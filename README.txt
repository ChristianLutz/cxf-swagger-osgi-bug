...
How to reproduce the problem:
  ...
  No opening your web browser an type: And all you see is the swagger header.
  http://localhost:8181/cxf/swaggerSample/swagger.json
  
  I guess the problem is the ClasspathHelper class from org.reflections it looks like that this one is not able to 
  access the osgi component. 
